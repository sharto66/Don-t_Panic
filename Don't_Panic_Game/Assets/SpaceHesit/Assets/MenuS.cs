...
public class MenuS : MonoBehaviour 
{
	...
	void OnGUI()
	{
		...
		{ 
			...
			if(Scoreboard.rComplete == true && Scoreboard.gComplete == true && Scoreboard.bComplete == true && Scoreboard.wComplete == true)
			{
			...
			else if (menu == true)
			{
				...
				if(GUI.Button(new Rect(Screen.width/2-69, Screen.height/2+5, 150, 40), "Resume") || Input.GetKey(KeyCode.R))
				{
					menu = false;
					Time.timeScale = 1;
